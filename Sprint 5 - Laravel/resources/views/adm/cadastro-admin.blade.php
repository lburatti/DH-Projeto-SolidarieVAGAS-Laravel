...
<section class="container opcoes-cadastros d-flex justify-content-around mb-2">
    <div class=" mx-auto cadastros">
        <div class=" form-group row col-12">
            <div class="card-body">
                <form method="POST" class="form-row" action="{{ route('adm.cadastro-admin.criar') }}">
                    @csrf
                    {{ method_field('POST') }}
                    <div id="texto-login-cadastro" class="form-group col-md-6">
                        <label for="nivel_acesso">{{ __('Nivel de Acesso') }}</label>
                    ...
                    <div id="texto-login-cadastro" class="form-group col-md-6">
                        <label for="cpf_cnpj">{{ __('CPF') }}</label>
                        <input id="cpf_cnpj" type="text" class="form-control login-cadastro-input @error('cpf_cnpj') is-invalid @enderror" name="cpf_cnpj" value="{{ old('cpf_cnpj') }}" required autocomplete="cpf_cnpj" autofocus>
                        @error('cpf_cnpj')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
