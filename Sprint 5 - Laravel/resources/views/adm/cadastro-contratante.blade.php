    ...
    <div class="p-3">
        ...
        <div class="mx-auto cadastros" id="accordionExample">
            <div id="" class="" aria-labelledby="headingThree" data-parent="#accordionExample">
                <div class="card-body">
                    <form action="{{ url('/adm/cadastro-contratante/editar/'.$user->id) }}" method="POST" class="form-row" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        <input type="hidden" id="txt-nivel-acesso" name="nivel_acesso" value="2">
