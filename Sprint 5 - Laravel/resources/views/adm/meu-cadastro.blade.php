        ...
        <div class="mx-auto cadastros" id="accordionExample">
            <div id="" class="" aria-labelledby="headingThree" data-parent="#accordionExample">
                <div class="card-body">
                    <!-- {{ $user = Auth::user()}} -->
                    <!-- @if(isset($user)) -->
                    <form action="{{ url('/adm/meu-cadastro/editar/'.$user->id) }}" method="POST" class="form-row" enctype="multipart/form-data">
                        @csrf
                        {{ method_field('PUT') }}
                        <div class="form-row formulario">
                            <div id="texto-login-cadastro" class="form-group col-md-12">
                                <label for="name">{{ __('Nome') }}</label>
                                <input id="name" type="text" class="form-control login-cadastro-input @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus>
                                @error('name')
                            ...
                            <div id="texto-login-cadastro" class="form-group col-md-6">
                                ...
                                <input type="text" name="cpf_cnpj" class="form-control login-cadastro-input @error('cpf_cnpj') is-invalid @enderror" id="cpf_cnpj" placeholder="000.000.000-00" value="{{ $user->cpf_cnpj }}" required autocomplete="birthday" autofocus>
                                @error('cpf_cnpj')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div id="texto-login-cadastro" class="form-group col-md-6">
                                ...
                                <input type="date" name="data_de_nasc_inicio" class="form-control login-cadastro-input @error('data_de_nasc_inicio') is-invalid @enderror" id="data_de_nasc_inicio" placeholder="000.000.000-00" value="{{ $user->data_de_nasc_inicio }}" required autocomplete="birthday" autofocus>
