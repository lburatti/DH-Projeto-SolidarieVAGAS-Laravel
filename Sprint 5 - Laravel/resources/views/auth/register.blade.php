...
@section('content')
    ...
    <div class="container opcoes-cadastros d-flex justify-content-around mb-2">
                ...
                <div class="card-body">
                    <form method="POST" class="form-row" action="{{ route('register') }}">
                        ...
                        <div id="texto-login-cadastro" class="form-group col-md-6">
                            <label for="nivel_acesso">{{ __('Contratantes ou Ongs') }}</label>
                            <select id="nivel_acesso" name="nivel_acesso" class="form-control login-cadastro-input @error('nivel_acesso') is-invalid @enderror" placeholder=" " value="{{ old('nivel_acesso') }}" required autocomplete="nivel_acesso" autofocus>
                                <option selected disabled value="nivel_acesso">Contratantes ou Ongs</option>
                                <option value="2">Contratantes</option>
                                <option value="3">Ongs</option>
                            </select>
                            @error('nivel_acesso')
                        ...
                        <div id="texto-login-cadastro" class="form-group col-md-6">
                            <div class="col-md-6 offset-md-4">
                                ...
                                {{-- <button type="submit" class="ml-auto btn btn-primary mt-5" >
                                    {{ __('Enviar') }}
                                </button>  --}}
