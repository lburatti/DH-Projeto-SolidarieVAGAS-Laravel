                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group col-md-12" id="texto-login-cadastro">
                            ...
                            <input type="email" class="form-control login-cadastro-input" id="email" aria-describedby="emailHelp" placeholder="email@email.com.br">
                            <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                        </div>
                        <div class="form-group col-md-12" id="texto-login-cadastro">
                            <label for="senha">Senha</label>
                            <input type="password" class="form-control login-cadastro-input" id="senha" placeholder="Digite uma senha">
                        </div>
